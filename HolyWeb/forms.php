...
<section style="position: relative; background-image: url('pics/holy.jpg'); background-size: 100% 100%; background-repeat: no-repeat; background-position: center; color: white; text-align: center; padding: 130px 20px; background-color: #1e2d40; overflow: hidden; margin-top: 66px;">
  ...
  <!-- Text Content -->
  <h1 style="position: relative; z-index: 1; font-size: 48px; margin: 0; font-weight: 700; font-family: 'Georgia', serif;">School Forms</h1>

</section>



<section style="padding: 30px; font-family: Arial, sans-serif; color: #333;">
  <!-- Enrollment Forms -->
  <h2 style="color: #0b1e45; font-weight: bold;">Enrollment Forms</h2>
  <hr style="border: 0; border-top: 1px solid #eee;">
  <p>CHCCI Enrollment Form (Filipino) Basic Education <a href="#" style="color: #f6a623; text-decoration: none;">Download</a></p>
  <p>CHCCI Enrollment Form (English) Basic Education <a href="#" style="color: #f6a623; text-decoration: none;">Download</a></p>
  <p>CHCCI Enrollment Form (English) College <a href="#" style="color: #f6a623; text-decoration: none;">Download</a></p>

  <!-- ID Request Form -->
  <h2 style="color: #0b1e45; font-weight: bold; margin-top: 40px;">ID Request Form</h2>
  <hr style="border: 0; border-top: 1px solid #eee;">
  <p>CHCCI ID Replacement Form <a href="#" style="color: #f6a623; text-decoration: none;">Download</a></p>

  <!-- Application for Graduation -->
  <h2 style="color: #0b1e45; font-weight: bold; margin-top: 40px;">CHCCI Application for Graduation Form</h2>
  <hr style="border: 0; border-top: 1px solid #eee;">
  <p>CHCCI Application for Graduation Form (English) Basic Education & College [print on Legal size paper] <a href="#" style="color: #f6a623; text-decoration: none;">Download</a></p>

  <!-- Student Handbooks -->
  <h2 style="color: #0b1e45; font-weight: bold; margin-top: 40px;">Student Handbooks</h2>
  <hr style="border: 0; border-top: 1px solid #eee;">
  <p>Basic Education Student Handbook <a href="#" style="color: #f6a623; text-decoration: none;">Download</a></p>
  <p>College Student Handbook <a href="#" style="color: #f6a623; text-decoration: none;">Download</a></p>
</section>

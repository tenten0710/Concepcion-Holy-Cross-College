...
<section style="position: relative; background-image: url('pics/holy.jpg'); background-size: 100% 100%; background-repeat: no-repeat; background-position: center; color: white; text-align: center; padding: 130px 20px; background-color: #1e2d40; overflow: hidden; margin-top: 66px;">
  ...
  <!-- Text Content -->
  <h1 style="position: relative; z-index: 1; font-size: 48px; margin: 0; font-weight: 700; font-family: 'Georgia', serif;">The CHCCI Story</h1>

</section>


<!-- Our Story Section -->
<section style="padding: 60px 20px; max-width: 900px; margin: 0 auto; font-family: Arial, sans-serif;">

  <!-- Title -->
  <h2 style="font-size: 36px; color: #1a1a1a; font-weight: 800; margin-bottom: 10px;">Our Story</h2>
  <p style="font-size: 18px; color: #555; margin-bottom: 30px;">This is CHCCI, we are Crossian!</p>
 ...
 <!-- School Story -->
<h3 style="font-size: 24px; color: #1a1a1a; font-weight: bold; margin-bottom: 10px;">History</h3>

<p style="font-size: 16px; color: #444; line-height: 1.8;">
  Concepcion Holy Cross College (CHCCI) was established in 1995 by Pablo L. Tioseco, Sr. and his daughter, Dr. Raquel T. Sta. Ines, with the vision of providing quality education to the youth of Concepcion, Tarlac. The founders aimed to create an institution that would allow local students to earn their degrees without having to travel to distant cities for higher education. Initially, the college offered programs in Teacher Education, Computer Science, and Business Administration, including secretarial courses. By 1999, the first batch of graduates celebrated their accomplishments, marking a significant milestone for the institution.
</p>

<p style="font-size: 16px; color: #444; line-height: 1.8;">
  As part of its commitment to enhancing educational services, CHCCI expanded its offerings and relocated to a new site at Rose Park in Barangay Minane in 2005, which provided a more conducive environment for learning. The college's mission focuses on developing students into morally upright and productive citizens. Over the years, CHCCI has added several academic programs at various levels, including preschool, elementary, secondary, and higher education, while also incorporating technical-vocational courses. Today, the college is recognized by various educational authorities, such as the Department of Education (DepEd) and the Commission on Higher Education (CHED), for its dedication to high standards in education and its contribution to uplifting the local community. Through its continued growth and development, CHCCI has emerged as a crucial educational institution within the region, committed to the holistic development of its students and fostering a brighter future for the community of Concepcion.
</p>

...
<section style="position: relative; background-image: url('pics/holy.jpg'); background-size: 100% 100%; background-repeat: no-repeat; background-position: center; color: white; text-align: center; padding: 130px 20px; background-color: #1e2d40; overflow: hidden; margin-top: 66px;">
  ...
  <!-- Text Content -->
  <h1 style="position: relative; z-index: 1; font-size: 48px; margin: 0; font-weight: 700; font-family: 'Georgia', serif;">School Vision</h1>
...
<section style="padding: 60px 20px; max-width: 900px; margin: 0 auto; font-family: Arial, sans-serif;">
  ...
  <!-- Title -->
  <h2 style="font-size: 36px; color: #1a1a1a; font-weight: 800; margin-bottom: 10px;">Our Vision</h2>
  ...
  <!-- School Vision -->
  <h3 style="font-size: 24px; color: #1a1a1a; font-weight: bold; margin-bottom: 10px;">School Vision</h3>
  <p style="font-size: 16px; color: #444; line-height: 1.8;">
    To become a God-centered learning institution focused on holistic education that forms and educates individuals to be conscientious, compassionate,
competent and committed persons towards the
development of just and humane society.
  </p>

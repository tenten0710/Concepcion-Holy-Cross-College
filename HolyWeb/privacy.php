...
<section style="position: relative; background-image: url('pics/holy.jpg'); background-size: 100% 100%; background-repeat: no-repeat; background-position: center; color: white; text-align: center; padding: 130px 20px; background-color: #1e2d40; overflow: hidden; margin-top: 66px;">
  ...
  <!-- Text Content -->
  <h1 style="position: relative; z-index: 1; font-size: 48px; margin: 0; font-weight: 700; font-family: 'Georgia', serif;">School Privacy Policy</h1>

</section>

<!-- Privacy Policy Section -->
<section style="font-family: 'Segoe UI', sans-serif; background: #f4f6f8; padding: 50px 20px;">
  <div style="max-width: 900px; margin: auto; background: #ffffff; padding: 40px 30px; border-radius: 16px; box-shadow: 0 8px 24px rgba(0,0,0,0.08);">
    <h2 style="font-size: 2.5rem; font-weight: 700; color: #1a1a1a; margin-bottom: 15px;">Privacy Policy</h2>
    <p style="font-size: 1.1rem; color: #555; line-height: 1.8; margin-bottom: 30px;">
      At <strong>Concepcion Holy Cross College</strong>, we respect your privacy and are committed to protecting the personal information you share with us. This Privacy Policy outlines how we collect, use, and safeguard your information when you visit our website.
    </p>

    <h3 style="font-size: 1.5rem; font-weight: 600; color: #333; margin-top: 30px;">Information We Collect</h3>
    <p style="font-size: 1rem; color: #444; line-height: 1.7;">
      We may collect personal information such as your name, email address, contact details, and any other information you provide through forms on our site. We also collect non-personal information such as browser type, operating system, and visited pages for analytics purposes.
    </p>

    <h3 style="font-size: 1.5rem; font-weight: 600; color: #333; margin-top: 30px;">How We Use Your Information</h3>
    <p style="font-size: 1rem; color: #444; line-height: 1.7;">
      The information we collect is used to:
      <ul style="margin-left: 20px; margin-top: 10px; color: #444;">
        <li>Process inquiries and provide academic information</li>
        <li>Enhance user experience on our website</li>
        <li>Send updates regarding school events and announcements</li>
        <li>Ensure website functionality and security</li>
      </ul>
    </p>

    <h3 style="font-size: 1.5rem; font-weight: 600; color: #333; margin-top: 30px;">Data Protection and Security</h3>
    <p style="font-size: 1rem; color: #444; line-height: 1.7;">
      We implement a range of security measures to protect your personal information. However, please note that no method of transmission over the internet is 100% secure.
    </p>

    <h3 style="font-size: 1.5rem; font-weight: 600; color: #333; margin-top: 30px;">Your Consent</h3>
    <p style="font-size: 1rem; color: #444; line-height: 1.7;">
    ...
    <h3 style="font-size: 1.5rem; font-weight: 600; color: #333; margin-top: 30px;">Contact Us</h3>
    <p style="font-size: 1rem; color: #444; line-height: 1.7;">
      If you have any questions or concerns about this Privacy Policy, please contact us at:
      <br><br>
      <strong>Email:</strong> support@chcc.edu.ph<br>
      <strong>Phone:</strong> (63) 012-345-6789
    </p>
  </div>
</section>

...
<section style="position: relative; background-image: url('pics/holy.jpg'); background-size: 100% 100%; background-repeat: no-repeat; background-position: center; color: white; text-align: center; padding: 130px 20px; background-color: #1e2d40; overflow: hidden; margin-top: 66px;">
  ...
  <!-- Text Content -->
  <h1 style="position: relative; z-index: 1; font-size: 48px; margin: 0; font-weight: 700; font-family: 'Georgia', serif;">School Goals & Objectives</h1>
...
<section style="padding: 60px 20px; max-width: 900px; margin: 0 auto; font-family: Arial, sans-serif;">
  ...
  <!-- Title -->
  <h2 style="font-size: 36px; color: #1a1a1a; font-weight: 800; margin-bottom: 10px;">Our Goals & Objectives</h2>
  ...
  <hr style="border: none; border-top: 1px solid #ccc; margin: 30px 0;">
    ...
    <!-- School Goals -->
    <h3 style="font-size: 24px; color: #1a1a1a; font-weight: bold; margin-bottom: 10px;">School Goals</h3>
    <ul style="font-size: 16px; color: #444; line-height: 1.8; padding-left: 20px;">
      <li>To develop a Christ-centered community;</li>
      <li>To produce intellectually-competent and wholly-developed graduates;</li>
      <li>To emphasize self-realization without compromising human dignity and moral values.</li>
    </ul>

    <!-- School Objectives -->
    <h3 style="font-size: 24px; color: #1a1a1a; font-weight: bold; margin-top: 30px; margin-bottom: 10px;">School Objectives</h3>
    <ul style="font-size: 16px; color: #444; line-height: 1.8; padding-left: 20px;">
      <li>To implement a dynamic, God-centered curriculum which will meet the ever-changing circumstances and needs of the society.</li>
      <li>To instill in the learner sound Christian principles, attitudes and values in dealing with interpersonal relationships.</li>
      <li>To guide the students in achieving basic knowledge and skills that will make them creative, productive and relevant members of the community.</li>
      <li>To make the students appreciate and value their Filipino cultural heritage.</li>
    </ul>

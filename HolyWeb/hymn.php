...
<section style="position: relative; background-image: url('pics/holy.jpg'); background-size: 100% 100%; background-repeat: no-repeat; background-position: center; color: white; text-align: center; padding: 130px 20px; background-color: #1e2d40; overflow: hidden; margin-top: 66px;">
  ...
  <!-- Text Content -->
  <h1 style="position: relative; z-index: 1; font-size: 48px; margin: 0; font-weight: 700; font-family: 'Georgia', serif;">School Hymn</h1>
 ...
 <!-- Hymn Section -->
<section style="padding: 40px 20px; font-family: Arial, sans-serif; text-align: center; max-width: 900px; margin: 0 auto;">

  <!-- Title -->
  <h2 style="font-size: 28px; color: #003366; font-weight: 800; text-transform: uppercase; margin-bottom: 20px; border-bottom: 1px solid #ccc; padding-bottom: 10px;">
    Holy Cross College<br>Hymn
  </h2>

  <!-- Hymn Lyrics -->
  <div style="font-size: 18px; color: #333; line-height: 2; font-family: 'Georgia', serif; max-width: 800px; margin: 0 auto;">
    For once, for all<br>
    We are rallying together<br>
    Behind you Alma Mater dear<br>
    Who has elevated knowledge to us<br>
    Inspiring us to sublimate your name<br>
    We students and alumni<br>
    Wherever we may be<br>
    Near or far we’ll always be<br>
    Loyal and ready to heed your call<br>
    For in the halls of Holy Cross College<br>
    Our knowledge and love for God and country<br>
    Radiates its light to our Alma Mater dear<br>
